...
Najlepszym miejscem dla obecnej wersji Daily jest **Oracle Cloud Infrastructure Always Free**, na jednej VM z Ubuntu/Oracle Linux, trwałym storage blokowym i systemd. Ta opcja zachowuje aktualny model wdrożenia: Node.js 22.23.2, SvelteKit `adapter-node`, plik SQLite, osobny worker co minutę i codzienny backup.
...
| Runtime | Node.js 22.23.2 i npm 10.9.8. |
...
2. Zainstalować dokładnie Node 22.23.2 i npm 10.9.8.
